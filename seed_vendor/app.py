...
COMPANY_NAMES = ["TechCorp", "Innovative Solutions", "Global Ventures", "NextGen Solutions", "BusinessCo"]
COUNTRIES = ["USA", "Canada", "UK", "Germany", "France"]
INDUSTRIES = ["Technology", "Healthcare", "Finance", "Retail", "Education"]
EMAIL_DOMAINS = ["example.com", "techcorp.com", "innovations.com", "ventures.com", "nextgen.com"]
...
def lambda_handler(event, context):
    ...
    try:
        ...
        return {
            'statusCode': 200,
            'body': f"Seeded {count} records successfully."
        }
        ...
        return {
            'statusCode': 500,
            'body': f"Error seeding data: {str(e)}"
        }
