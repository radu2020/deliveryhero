...
def setup_dynamodb():
    with mock_aws():
        ...
        incentive_table.meta.client.get_waiter("table_exists").wait(
            TableName=TABLE_INCENTIVE
        )

        # Insert mock data
        vendor_table.put_item(
            Item={
                "vendor_id": "123",
...
def test_get_vendor_200_success():
    ...
    test_event = {"httpMethod": "GET", "pathParameters": {"vendor_id": "123"}}
...
def test_get_vendor_404_not_found():
    ...
    test_event = {"httpMethod": "GET", "pathParameters": {"vendor_id": "nonexistent"}}
